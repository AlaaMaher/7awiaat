...
public class GPSUserLocation extends Service implements LocationListener {
    ...
    public GPSUserLocation(Context context) {
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            locationManager.removeUpdates(GPSUserLocation.this);
        }
    }
