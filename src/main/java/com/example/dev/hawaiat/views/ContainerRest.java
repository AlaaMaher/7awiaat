...
public class ContainerRest extends AppCompatActivity {
    ...
    private String containerType = "rest";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //containerType=intent.getExtras().getString("rest");
    ...
    public class CustomAdapter extends ArrayAdapter<Item> {
        ...
        public View getView(final int pos, View view, ViewGroup viewGroup) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(ContainerRest.this, "item selected" + items.get(pos).getText(), Toast.LENGTH_SHORT).show();
                    listPopup.dismiss();
                }
            });
            return view;
...
/*public  class Containers1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SendOrder.ContainersAdapter adapter = new SendOrder.ContainersAdapter(this, containerSizes);
        recyclerView.setAdapter(adapter);
